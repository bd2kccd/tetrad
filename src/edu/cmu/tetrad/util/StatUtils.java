...
public final class StatUtils {
    ...
    public static double kendallsTau(double[] x, double[] y) {
        ...
        for (int i = 0; i < N; i++) {
            for (int j = i + 1; j < N; j++) {
                numer += signum(x[i] - x[j]) * signum(y[i] - y[j]);
            }
        }
...
//        }
//
//        int numer = (concordant - discordant;
...
//
//        TetradMatrix var1Matrix = submatrix.viewSelection(selection1, selection1);
...
//
//        TetradMatrix var2Matrix = submatrix.viewSelection(selection2, selection2);
...
//        if (submatrix.rows() > 2) {
//            TetradMatrix corr = submatrix.like();
//
//            for (int i = 0; i < co`rr.rows(); i++) {
//                for (int j = i + 1; j < corr.columns(); j++) {
//                    double c = submatrix.get(i, j) / Math.sqrt(submatrix.get(i, i) * submatrix.get(j, j));
//                    corr.set(i, j, c);
//                    corr.set(j, i, c);
//                }
//            }
...
////            System.out.println();
//
//            for (int j = 2; j < corr.columns(); j++) {
//                for (int i = 0; i < 2; i++) {
//                    if (abs(corr.get(i, j)) < 0.05) {
////                        System.out.println(corr.get(i, j));
//                        return 1.0;
//                    }
//                }
//            }
