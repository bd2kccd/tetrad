...
public final class DataUtils {
    ...
    public static List<DataSet> standardizeData(List<DataSet> dataSets) {
        ...
        for (DataSet dataSet : dataSets) {
            ...
            ColtDataSet dataSet2 = ColtDataSet.makeContinuousData(dataSet.getVariables(), data2);
...
//        }
     ...
     * Returns the submatrix of m with variables in the order of the x variables.
     */
    public static synchronized TetradMatrix subMatrix(TetradMatrix m, Map<Node, Integer> indexMap, Node x, Node y, List<Node> z) {
        if (x == null) {
            throw new NullPointerException();
        }
...
//    }
     ...
     */
    public static DataSet center(DataSet data) {
        DataSet _data = new ColtDataSet((ColtDataSet) data);
    ...
    public static Knowledge createRequiredKnowledge(Graph resultGraph) {
...
//                    knowledge.setEdgeForbidden(node2.getName(), node1.getName(), true);
                    ...
                    Node node2 = edge.getNode2();
                    knowledge.setEdgeRequired(node1.getName(), node2.getName(), true);
                    knowledge.setEdgeRequired(node2.getName(), node1.getName(), true);
                }
            }
        }
