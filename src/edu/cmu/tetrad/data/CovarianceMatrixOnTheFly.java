...
//        matrixC = TetradMatrix.instance(m, m);
...
//        }
    ...
    private void zeroCenter(TetradMatrix data) {
...
//        }
//
//        TetradMatrix cov = matrixC.viewSelection(indices, indices);
...
//    }
    ...
    private void readObject(ObjectInputStream s)
        ...
        if (matrix != null) {
//            matrixC = TetradMatrix.instance(matrix);
            matrix = null;
        }
