...
//		System.out.println("data = "+dat);
		...
		TetradMatrix data = gibbsEstimator.getDataSet();
...
//		System.out.println();
//
//		TetradMatrix coef1 = estimator.getEstimatedSem().getEdgeCoef();
//		TetradMatrix coef2 = gibbsEstimator.getEstimatedSem().getEdgeCoef();
