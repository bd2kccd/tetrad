...
public final class DistanceFromSelected {
    ...
    public DistanceFromSelected(LayoutEditable layoutEditable) {
        ...
        for (Node node : graph.getNodes()) {
            Map modelToDisplay = layoutEditable.getModelToDisplay();
    ...
    public void doLayout() {
        ...
        for (List<Node> tier : tiers) {
            ...
            DisplayNode displayNode = (DisplayNode) layoutEditable.getModelToDisplay().get(node);
            ...
            for (int i = 1; i < tier.size(); i++) {
                node = tier.get(i);
                displayNode = (DisplayNode) layoutEditable.getModelToDisplay().get(node);
