...
//    Bollen and Ting, Confirmatory Tetrad Analysis, p. 164 Sympathy and Anger.
    ...
    public void testBollenExampleb() {
        ...
        try {
            String dir = "/Users/josephramsey/Documents/LAB_NOTEBOOK.2012.04.20/2014.02.20/kummerfeld.spirtes.yang.ramsey";
            String name = "dataLG.txt";

//            PrintWriter out = new PrintWriter(new File(dir, name));
//            DataWriter.writeRectangularData(data, out, '\t');

            DataReader reader = new DataReader();
            data = reader.parseTabular(new File(dir, name));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        RandomUtil.getInstance().setSeed(4737572747L);
        ...
        FindTwoFactorClusters ftfc = new FindTwoFactorClusters(data, TestType.TETRAD_BOLLEN, 0.01);
