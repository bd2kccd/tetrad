...
//        System.out.println("orientUnshieldedTriples 1");
        ...
        for (Node y : nodes) {
            ...
            while ((combination = cg.next()) != null) {
                ...
                SearchGraphUtils.CpcTripleType type = null;
                ...
                if (sepset != null) {
                    ...
                    if (!test.isIndependent(x, z, sepset2)) {
                        sepset2 = null;
                    }

                    if (!sepset.contains(y) && sepset2 == null) {
                        type = SearchGraphUtils.CpcTripleType.COLLIDER;
                    }
                    else if (sepset.contains(y) && sepset2 == null) {
                        type = SearchGraphUtils.CpcTripleType.NONCOLLIDER;
                    }
                    else {
                        type = SearchGraphUtils.CpcTripleType.AMBIGUOUS;
                    }
                }
