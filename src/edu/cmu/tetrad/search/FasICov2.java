 ...
 */
public class FasICov2 implements IFas {
     ...
     */
    public FasICov2(IndependenceTest test) {
...
//                            System.out.println(SearchLogUtils.independenceFactMsg(x, y, theRest, test.getPValue()));
                            System.out.println(x + " _||_ " + y + " | empty" + " p = " +
                    ...
                    if (independent) {
                        ...
                        if (verbose) {
                            System.out.println(SearchLogUtils.independenceFactMsg(x, y, new ArrayList<Node>(), test.getPValue()));
...
//            if (!adjacencies.get(_x).contains(_y)) return removed;
            ...
            if (verbose) {
                System.out.println(SearchLogUtils.independenceFactMsg(_x, _y, Collections.singletonList(_z), test.getPValue()));
//                            System.out.println(_x + " _||_ " + _y + " | the rest" + " p = " +
//                                    nf.format(test.getPValue()));
            }
...
//
//                if (verbose) {
//                    System.out.println(SearchLogUtils.independenceFactMsg(_x, _y, Collections.singletonList(z), test.getPValue()));
////                            System.out.println(_x + " _||_ " + _y + " | the rest" + " p = " +
////                                    nf.format(test.getPValue()));
//                }
//
...
////
////                    if (verbose) {
////                        System.out.println(SearchLogUtils.independenceFactMsg(_x, _y, condSet, test.getPValue()));
//////                            System.out.println(x + " _||_ " + y + " | the rest" + " p = " +
//////                                    nf.format(test.getPValue()));
////                    }
////
...
////
////                                if (verbose) {
////                                    System.out.println(SearchLogUtils.independenceFactMsg(_x2, _y2, condSet, test.getPValue()));
////                                }
////
////                                removed = true;
////                            }
                ...
                if (ppx.size() >= depth) {
                    ...
                    while ((choice = cg.next()) != null) {
                        ...
                        if (independent && noEdgeRequired) {
                            ...
                            if (verbose) {
                                System.out.println("SearchAtDepth: " + SearchLogUtils.independenceFactMsg(x, y, condSet, test.getPValue()));
                            }
