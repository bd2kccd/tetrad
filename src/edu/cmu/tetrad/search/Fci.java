...
public final class Fci implements GraphSearch {
    ...
    private boolean RRFCI_Used = false;
...
//        System.out.println("RFCI = " + RFCI_Used);
//        System.out.println("RRFCI = " + RRFCI_Used);
//        System.out.println("Complete rule set used = " + completeRuleSetUsed);
//        System.out.println("Possible dsep used = " + possibleDsepSearchDone);
...
//        fas.setFci(true);
	...
	//        // Optional step: Possible Dsep. (Needed for correctness but very time consuming.)
		...
		else 
		{
			...
			doFinalOrientation_RFCI_or_RRFCI();
		}
...
//    }
    ...
    public void setRFCI_Used(boolean used) {
        this.RFCI_Used = used;
        this.RRFCI_Used = !used;
    }

    public void setRRFCI_Used(boolean used) {
        this.RRFCI_Used = used;
        this.RFCI_Used = !used;
    }
    ...
    //////////////////////////////////////////////////
    private void doFinalOrientation_RFCI_or_RRFCI() {
        ...
        for (Node b : nodes) {
            ...
            for (Node a : possA) {
                for (Node c : possC) {
					...
					if ((RFCI_Used || RRFCI_Used) && changeFlag)
					{
						return;
					}
                }
    ...
    private void rulesR8R9R10() {
        ...
        for (Node c : nodes) {
            ...
            for (Node a : intoCArrows) {
                ...
                if (!ruleR8(a, c)) {
                    boolean b = !RRFCI_Used ? ruleR9(a, c) : false;
...
//            System.out.println("Tail path " + n1 + "---" + n2);
     ...
     * @param ucPdPaths The getModel list of uncovered p.d. paths.
     */
