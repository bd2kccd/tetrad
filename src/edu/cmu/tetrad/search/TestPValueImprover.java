...
//            pattern = new EdgeListGraph(truePattern);
            ...
            BffBeam bff = new BffBeam(pattern, data, new Knowledge());
...
//            bff.setCheckingCycles(false);
            ...
            TetradMatrix trueCorr = im2.getImplCovar();
...
//            pattern = new EdgeListGraph(truePattern);
            ...
            BffBeam improver = new BffBeam(pattern, data, new Knowledge());
...
//            TetradMatrix trueCorr = MatrixUtils.convertCovToCorr(im.getImplCovar());
            ...
            TetradMatrix newCorr = improver.getNewSemIm().getImplCovar();
            TetradMatrix dataCorr = new CovarianceMatrix(data).getMatrix();
