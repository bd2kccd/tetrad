...
//        RandomUtil.getInstance().setSeed(127679241L);
        ...
        Graph mim = GraphUtils.randomSingleFactorModel(numLatents, numLatentEdges, numMeasurementsPerLatent,
                numImpurities, numImpurities, 0);
...
//        DataUtils.center(subClusterData);
...
//
        ...
        jcpc.setSoftmaxAdjacencies(15);
        jcpc.setMaxIterations(40);
        jcpc.setKnowledge(new Knowledge());
