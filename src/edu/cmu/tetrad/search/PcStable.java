...
public class PcStable implements GraphSearch {
    ...
    /**
     * Prints independencies info to System.out.
     */
...
//        FasStable fas = new FasStable(graph, getIndependenceTest());
...
//        Fas6 fas = new Fas6(graph, getIndependenceTest());
        ...
        // tests whether Y can be added into the sepset for X--Y--Z
//        SearchGraphUtils.orientCollidersUsingSepsets4(this.sepsets, knowledge, graph, independenceTest);
