...
//    private TetradMatrix covariances;
     ...
     * For linear algebra.
     */
    private final TetradAlgebra algebra = new TetradAlgebra();                        // s = vv * x, or s12 = Theta.1 * Theta.12
...
//            if (covariances != null && minJump == 0 && isUseMinimumJump()) {
...
//     */
//    public boolean isUseMinimumJump() {
//        return useFCutoff;
//    }
//
...
//    }
//
//    public void setMinimumJump(double fCutoffP) {
...
//        int n = dataSets().get(dataIndex).getNumRows();
        ...
        if (parents.length > 0) {
            ...
            TetradMatrix Czz =
                    getCovMatrices().get(dataIndex).getSelection(parents, parents);
...
//                inverse = MatrixUtils.ginverse(Czz);
            ...
            TetradVector Cyz = getCovMatrices().get(dataIndex).getColumn(i);
