...
public final class TestGraph extends TestCase {
    ...
    public void testDSeparation() {
        Graph graph = GraphUtils.randomDag(7, 7, true);
    ...
    public void testDSeparation2() {
        EdgeListGraph graph = new EdgeListGraph(GraphUtils.randomDag(7, 7, true));
        ...
        for (int i = 0; i < nodes.size(); i++) {
            for (int j = i + 1; j < nodes.size(); j++) {
                ...
                while ((choice = gen.next()) != null) {
                    ...
                    boolean dConnectedTo1 = graph.isDConnectedTo1(y, x, z);
    ...
    public void testDSeparation4() {
        Graph graph = GraphUtils.randomDag(250, 50, 450, 100, 100, 100, false);
        ...
        Fci fci2 = new Fci(test);
        fci2.setRRFCI_Used(true);
        Fas fas2 = new Fas(test);
        start = System.currentTimeMillis();
        fci2.setDepth(depth);
        fci2.search(fas2, fas2.getNodes());
        stop = System.currentTimeMillis();

        System.out.println("DSEP RRFCI");
        System.out.println("# dsep checks = " + fas2.getNumIndependenceTests());
        System.out.println("Elapsed " + (stop - start));
        System.out.println("Per " + fas2.getNumIndependenceTests() / (double) (stop - start));
        ...
        Fci fci3 = new Fci(test2);
        fci3.setRFCI_Used(true);
        Fas fas3 = new Fas(test2);
        start = System.currentTimeMillis();
        fci3.setDepth(depth);
        ...
        Fci fci4 = new Fci(test2);
        fci4.setRRFCI_Used(true);
        Fas fas4 = new Fas(test2);
        start = System.currentTimeMillis();
        fci4.setDepth(depth);
        fci4.search(fas4, fas4.getNodes());
        stop = System.currentTimeMillis();

        System.out.println("FISHER Z RRFCI");
        System.out.println("# indep checks = " + fas4.getNumIndependenceTests());
        System.out.println("Elapsed " + (stop - start));
        System.out.println("Per " + fas4.getNumIndependenceTests() / (double) (stop - start));
    }
