 ...
 */
public class Pc5 implements GraphSearch {
     ...
     */
    public Pc5(IndependenceTest independenceTest) {
...
//        SearchGraphUtils.orientCollidersUsingSepsets(this.sepsets, knowledge, graph, verbose);
        SearchGraphUtils.orientCollidersUsingSepsets4(this.sepsets, knowledge, graph, getIndependenceTest());
