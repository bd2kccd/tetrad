 ...
 */
public class Pc3 implements GraphSearch {
     ...
     */
    public Pc3(IndependenceTest independenceTest) {
...
//        SearchGraphUtils.orientCollidersUsingSepsets(this.sepsets, knowledge, graph, verbose);
        SearchGraphUtils.orientCollidersUsingSepsets(this.sepsets, knowledge, graph, getIndependenceTest());
