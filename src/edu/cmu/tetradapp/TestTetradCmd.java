...
public class TestTetradCmd extends TestCase {
    ...
    public void rtest1() {
        new TetradCmd(new String[] {"-verbose", "-data", "sample_data/data1.txt",
                     ...
                     "-significance", "0.05", "-knowledge", "sample_data/knowledge1.txt"});
    ...
    public void rtest2() {
        new TetradCmd(new String[] {"-data", "sample_data/avatarwithdependencies.esv",
                     ...
                     "-significance", "0.05", "-knowledge", "sample_data/avatarknowledge.txt"});
    ...
    public void test3() {
        new TetradCmd(new String[] {"-data", "sample_data/eigenvox2.txt",
                     ...
                     "-significance", "0.05", "-verbose", "-whitespace"});


    }

    public void test4() {
        new TetradCmd(new String[] {"-covariance", "sample_data/eigenvox2.txt",
                "-datatype", "continuous", "-algorithm", "cpc", "-depth", "3",
                "-significance", "0.05", "-verbose", "-whitespace"});
