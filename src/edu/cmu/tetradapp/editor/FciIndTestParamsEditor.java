...
class FciIndTestParamsEditor extends JComponent {
    ...
    /**
     * An int field to specify the maximum length of reachable paths (in discriminating path orientation and
     * possible dsep).
     */
     ...
     * A checkbox to allow the user to specify whether to use RFCI
     */
    private JCheckBox RRFCI_CheckBox;
    ...
    public FciIndTestParamsEditor(FciIndTestParams params) {
        ...
        completeRuleSetCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                else if (RRFCI_CheckBox.isSelected()) {
                    indTestParams().setCompleteRuleSetUsed(false);
                }
                else {
        ...
        RFCI_CheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                indTestParams().setRRFCI_Used(false);
                indTestParams().setCompleteRuleSetUsed(true);
                indTestParams().setPossibleDsepDone(false);

                RRFCI_CheckBox.setSelected(indTestParams().isRRFCI_Used());
        ...
        RRFCI_CheckBox = new JCheckBox();
        RRFCI_CheckBox.setSelected(indTestParams().isRRFCI_Used());
        RRFCI_CheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                JCheckBox source = (JCheckBox) actionEvent.getSource();
                boolean selected = source.isSelected();
                indTestParams().setRRFCI_Used(selected);
                indTestParams().setRFCI_Used(false);
                indTestParams().setCompleteRuleSetUsed(true);
                indTestParams().setPossibleDsepDone(false);
        ...
        possibleDsepCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                if (RRFCI_CheckBox.isSelected() || RFCI_CheckBox.isSelected()) {
                    indTestParams().setPossibleDsepDone(false);
    ...
    private void buildGui() {
        ...
        b7.add(new JLabel("Use RRFCI (Experimental): "));
        b7.add(RRFCI_CheckBox);
        add(b7);
