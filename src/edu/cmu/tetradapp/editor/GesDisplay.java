...
public class GesDisplay extends JPanel implements GraphEditable {
    ...
    public GesDisplay(final List<ScoredGraph> topGraphs, Indexable indexable) {
...
//        spinner = new JSpinner();
    ...
    private void setDisplayScore() {
        if (topGraphs.isEmpty()) {
            ...
            scoreLabel.setText(nf.format(topGraphs.get(getIndexable().getIndex()).getScore()));
        }
    }
