...
public class KnowledgeBoxEditor extends JPanel {
     ...
     */
    private KnowledgeBoxEditor(Knowledge knowledge, List<String> varNames) {
        if (knowledge == null) {
    ...
    private JMenuBar menuBar() {
        ...
        load.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Knowledge knowledge = new DataReader().parseKnowledge(file);
...
//                }
    ...
    private Box getTierBoxes(int numTiers) {
        ...
        List varsNotInTiers = getKnowledge().getVarsNotInTier();
