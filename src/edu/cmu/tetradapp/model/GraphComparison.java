...
//            this.params.setReferenceGraphName(model1.getName());
    ...
    public String getComparisonString() {
        return GraphUtils.graphComparisonString(getParams().getTargetGraphName(), targetGraph,
...
//
//                if (Edges.isDirectedEdge(edge) && GraphUtils.existsSemidirectedPathFromTo(referenceGraph, node1, node2)) {
//                    directedInReference = true;
//                } else if ((Edges.isDirectedEdge(edge) || Edges.isBidirectedEdge(edge)) &&
//                        (GraphUtils.existsSemidirectedPathFromTo(referenceGraph, node1, node2) ||
//                        GraphUtils.existsSemidirectedPathFromTo(referenceGraph, node2, node1))) {
//                    directedInReference = true;
//                }
//
...
//
//                if (Edges.isDirectedEdge(edge) && GraphUtils.existsSemidirectedPathFromTo(targetGraph, node1, node2)) {
//                    directedInTarget = true;
//                } else if ((Edges.isDirectedEdge(edge) || Edges.isBidirectedEdge(edge)) &&
//                        (GraphUtils.existsSemidirectedPathFromTo(targetGraph, node1, node2) ||
//                        GraphUtils.existsSemidirectedPathFromTo(targetGraph, node2, node1))) {
//                    directedInTarget = true;
//                }
//
////                Graph graph = comparison.getTargetGraph();
