...
// Add antilog arcsinh, arccosh, arctahn,
//  e, gamma, incomplete gamma, log base, ln, pi
...
//        descriptor.add(new LogNormalExpressionDescriptor());

        // "Normal" must come before "N".
...
//        descriptor.add(new GaussianPowerExpressionDescriptor());
...
//        descriptor.add(new SingleValueExpressionDescriptor());
        descriptors.add(new HyperbolicExpressionDescriptor());

        // "Uniform" must come before "U".
...
//        Collections.sort(descriptor, new Comp());
    ...
    private static class LogisticExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public LogisticExpressionDescriptor() {
            super("Logistic tangent", "logistic", Position.PREFIX, false, false, true, "expr");
        }
    ...
    private static class ExponentialExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public ExponentialExpressionDescriptor() {
            super("Exponential", "Exponential", Position.PREFIX, false, false, true, "expr");
        }
    ...
    // "abs(Normal(0, 1) ^ power))
    private static class GaussianPowerExpressionDescriptor extends AbstractExpressionDescriptor {
        static final long serialVersionUID = 23L;

        public GaussianPowerExpressionDescriptor() {
            super("GaussianPower", "GaussianPower", Position.PREFIX, false, false, true, "expr");
        }
        ...
        public Expression createExpression(Expression... expressions) throws ExpressionInitializationException {
            ...
            return new AbstractExpression("GaussianPower", Position.PREFIX, expressions){
                static final long serialVersionUID = 23L;
                public double evaluate(Context context) {
                    Expression exp1 = getExpressions().get(0);
...
//                            System.out.println("a[" + i + "] = " + a[i] + " sum = " + sum);
    ...
    private static class StudentTExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public StudentTExpressionDescriptor() {
            super("Student T", "StudentT", Position.PREFIX, false, false, true, "expr");
        }
        ...
        public Expression createExpression(Expression... expressions) throws ExpressionInitializationException {
            ...
            return new AbstractExpression("StudentT", Position.PREFIX, expressions) {
                ...
                public double evaluate(Context context) {
                    Expression exp1 = getExpressions().get(0);
                    return RandomUtil.getInstance().nextT(exp1.evaluate(context));
                }
            };
        }
    }

    private static class SingleValueExpressionDescriptor extends AbstractExpressionDescriptor {
        static final long serialVersionUID = 23L;

        public SingleValueExpressionDescriptor() {
            super("Single Value", "SingleValue", Position.PREFIX, false, false, true, "expr");
        }
        ...
        public Expression createExpression(final Expression... expressions) throws ExpressionInitializationException {
            ...
            return new AbstractExpression("SingleValue", Position.PREFIX, expressions){
                static final long serialVersionUID = 23L;
                public double evaluate(Context context) {
                    Expression exp1 = getExpressions().get(0);
    ...
    private static class UExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public Expression createExpression(Expression... expressions) throws ExpressionInitializationException {
            ...
            return new AbstractExpression("U", Position.PREFIX, expressions) {
                static final long serialVersionUID = 23L;
                public double evaluate(Context context) {
                    Expression exp1 = getExpressions().get(0);
                    Expression exp2 = getExpressions().get(1);
                    double a = exp1.evaluate(context);
                    double b = exp2.evaluate(context);

                    if (a >= b) {
                        return Double.NaN;
//                        throw new IllegalArgumentException("For Uniform, a must be less than b.");
                    }
...
//                        throw new IllegalArgumentException("For Uniform, a must be less than b.");
    ...
    private static class VonMisesExpressionDescriptor extends AbstractExpressionDescriptor {
        static final long serialVersionUID = 23L;

        public VonMisesExpressionDescriptor() {
            super("VonMises", "VonMises", Position.PREFIX, false, false, true, "expr");
        }
        ...
        public Expression createExpression(Expression... expressions) throws ExpressionInitializationException {
            ...
            return new AbstractExpression("VonMises", Position.PREFIX, expressions) {
                static final long serialVersionUID = 23L;
                public double evaluate(Context context) {
                    Expression exp1 = getExpressions().get(0);
    ...
    private static class LessThanOrEqualExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public LessThanOrEqualExpressionDescriptor() {
            super("Less Than Or Equal", "<=", Position.BOTH, true, true, true);
        }
    ...
    private static class GreaterThanOrEqualExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public GreaterThanOrEqualExpressionDescriptor() {
            super("Greater Than Or Equal", ">=", Position.BOTH, true, true, true);
        }
