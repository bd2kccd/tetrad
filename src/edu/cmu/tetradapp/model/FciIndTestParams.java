...
public final class FciIndTestParams implements IndTestParams {
    ...
    /**
     * True iff the RRFCI (Experimental) should be used.
     */
    ...
    /**
     * The maximum length of discriminating paths, or -1 or unlimited.
     */
   ...
   //============================CONSTRUCTORS=========================//
    ...
    public void setRRFCI_Used(boolean RRFCI_Used) {
        this.RRFCI_Used = RRFCI_Used;
    }
