...
//            setResultGraph(graph);
        ...
        if (indTestParams.isRFCI_Used()) fci.setRFCI_Used(true);
        if (indTestParams.isRRFCI_Used()) fci.setRRFCI_Used(true);
...
//        triplesList.add(GraphUtils.getDefiniteCollidersFromGraph(node, graph));
//        triplesList.add(GraphUtils.getDefiniteNoncollidersFromGraph(node, graph));
        return triplesList;
    }
