...
//        }
    ...
    public void execute() {
        ...
        List<Node> regressorNodes = regressorsDataSet.getVariables();
        ...
        logRegression.regress((DiscreteVariable) target, regressorNodes);
     ...
     * for the given node.
     * @param node The node that the classifications are for. All triple from adjacents to this
     * node to adjacents to this node through the given node will be considered.
     */
