...
public class CorrectManipulatedGraphSemIm {
    ...
    public static SemIm createIm(SemIm correctSemIm, ExperimentalSetup experiment) {
        ...
        for (Object ob : nodes) {
            ...
            if ((experiment.getManipulation(node) instanceof Randomized)) {
                Randomized randomized = (Randomized) experiment.getManipulation(node);
                Distribution distribution = randomized.getDistribution();

//                double stdDev = randomized.getStandardDeviation();
//                im.setMean(node, randomized.getMean());
//
