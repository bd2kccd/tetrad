 ...
 */
public class SemGraphToolbar extends GraphToolbar
    ...
    public SemGraphToolbar(GraphWorkbench workbench) {
        ...
        //addUnorientedEdge = new JToggleButton();
        ...
        //addHalfdirectedEdge = new JToggleButton();
        ...
        //addUnorientedEdge.addFocusListener(focusListener);
        addDirectedEdge.addFocusListener(focusListener);
        //addHalfdirectedEdge.addFocusListener(focusListener);
        ...
        //addUnorientedEdge.addActionListener(new ActionListener() {

        /**
         * Sets the flowbench tool to EDGE.
         */
        /*    public void actionPerformed(ActionEvent e) {
                addUnorientedEdge.getModel().setSelected(true);
                setWorkbenchMode(GraphWorkbench.ADD_EDGE);
                setEdgeMode(GraphWorkbench.UNORIENTED_EDGE);
            }
        });*/
        //addHalfdirectedEdge.addActionListener(new ActionListener() {

        /**
         * Sets the flowbench tool to ESTIMATE.
         */
        /*    public void actionPerformed(ActionEvent e) {
                addHalfdirectedEdge.getModel().setSelected(true);
                setWorkbenchMode(GraphWorkbench.ADD_EDGE);
                setEdgeMode(GraphWorkbench.HALFDIRECTED_EDGE);
            }
        });*/
        //addBidirectedEdge.addActionListener(new ActionListener() {

        /**
         * Sets the flowbench tool to SEARCH.
         */
        /*    public void actionPerformed(ActionEvent e) {
        ...
        /*addButton(addUnorientedEdge, "unoriented");
        addButton(addHalfdirectedEdge, "halfdirected");
    ...
    private void selectArrowTools() {
        ...
        /*addUnorientedEdge.setEnabled(true);
        addHalfdirectedEdge.setEnabled(true);
